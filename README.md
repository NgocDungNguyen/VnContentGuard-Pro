#  VnContentGuard Pro V7.0

**Hệ thống kiểm duyệt nội dung tiếng Việt bằng AI  Phiên bản đầy đủ tính năng**

[![Version](https://img.shields.io/badge/version-7.0.0-purple.svg)](https://github.com/NgocDungNguyen/VnContentGuard-Pro)
...
> **V7.0:** Unified AI (70% API calls)  Structured scraping  YouTube & TikTok  Content overlay  SSE streaming  Community blocklist  Parental control

---

##  Tính năng chính (V7.0)

###  ARCH-01  Phân tích thống nhất (Unified Analysis)
Thay vì gọi AI 3-5 lần riêng lẻ, V7.0 dùng **1 lần gọi Gemini duy nhất** cho toàn bộ phân tích:
