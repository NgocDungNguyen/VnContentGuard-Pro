...
class TestFactCheckerV3:
    ...
    def test_check_without_url(self):
        ...
        assert result['verdict'] in ['Verified True', 'Likely True', 'Unclear', 'Likely False', 'False']
    ...
    def test_likely_true_claim(self):
        ...
        print(f"✅ Likely true claim test passed (Score: {result['score']}, Verdict: {result['verdict']}, Methods: {len(result['verification_methods'])})")
    ...
    def test_likely_false_claim(self):
        ...
        print(f"✅ Likely false claim test passed (Score: {result['score']}, Verdict: {result['verdict']}, Methods: {len(result['verification_methods'])})")
...
class TestSourceAnalyzer:
    ...
    def test_url_with_path(self):
        ...
        result = self.analyzer.analyze("https://vnexpress.net/tin-tuc/chinh-tri/article123")
...
class TestNewsAggregator:
    ...
    def test_match_score_calculation(self):
        ...
        print(f"✅ Match score calculation test passed (Score: {result['match_score']})")
