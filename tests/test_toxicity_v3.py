"""
Unit Tests for VnContentGuard Pro v3 - Advanced Toxicity Detection
===================================================================
...
class TestToxicityV3Initialization:
...
class TestToxicContent:
    ...
    def test_vietnamese_insult(self):
        ...
        assert 'detoxify' in result['detection_layers'] or 'regex' in result['detection_layers']
