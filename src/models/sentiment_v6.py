"""
VnContentGuard Pro v6 - Enhanced Sentiment Analysis
...
class SentimentAnalyzerV6:
    ...
    def __init__(self, use_phobert: bool = True):
        ...
        if not self.phobert_available:
            logger.info("✅ Sentiment Analyzer v6 initialized (keyword fallback mode)")
        else:
            logger.info("✅ Sentiment Analyzer v6 initialized (PhoBERT mode)")
...
# Quick test function
def test_sentiment_v6():
    """Test the v6 sentiment analyzer."""
    analyzer = SentimentAnalyzerV6()
    ...
    print("\n" + "=" * 60)
    print("🧪 Sentiment v6 test results")
    print("=" * 60)
