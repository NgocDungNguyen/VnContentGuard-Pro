...
class ToxicityAnalyzerV3:
    ...
    def __init__(self):
        ...
        if self.use_gemini:
            ...
            print("⚠️ Layer 4: Gemini AI disabled (enable with USE_GEMINI_TOXICITY=true)")
    ...
    def analyze(self, text: str) -> Dict:
        ...
        if detoxify_result:
            ...
            results['overall_score'] = max(results['overall_score'], detoxify_result['max_score'])
        ...
        if regex_result:
            ...
            if regex_result['is_toxic']:
                ...
                results['overall_score'] = max(results['overall_score'], 0.8)  # High confidence for regex
        ...
        if self.perspective_api_key:
            ...
            if perspective_result:
                ...
                results['overall_score'] = max(results['overall_score'], perspective_result['max_score'])
