"""
VnContentGuard Pro v3 - News Aggregator & Cross-Reference
==========================================================
...
class NewsAggregator:
    ...
    def __init__(self):
        print("⏳ Initializing News Aggregator v3...")
        ...
        print("✅ News Aggregator v3 Ready!")
    ...
    async def _search_newsdata(self, query: str, language: str) -> Optional[Dict]:
        ...
        try:
            ...
            async with aiohttp.ClientSession() as session:
                async with session.get(self.newsdata_url, params=params, timeout=10) as response:
...
if __name__ == "__main__":
    ...
    test_queries = [
        "COVID-19 vaccine",
        "Việt Nam kinh tế 2024",
        "climate change"
    ]
    
    print("\n🧪 Testing News Aggregator v3:")
